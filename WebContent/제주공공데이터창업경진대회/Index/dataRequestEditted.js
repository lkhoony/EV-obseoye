...
//			
	        // marker에 click 이벤트등록
	        kakao.maps.event.addListener(marker, 'click',clickCb);
...
//				var martCont = "";
				    	...
				    	for(var i=0;i<len;i++){
				    		...
				    		var content =
					        		...
					        		+  
			              			result[i].place_name+
			                	"</div>";
				    		if(result[i].category_group_code==="FD6"){
				    			if(i===0){
				    				$(".restaurant_box .aside_box_wrap").html("");
				    			}
				    			
				    			$(".restaurant_box .aside_box_wrap").append(content);
				    		}else if(result[i].category_group_code==="CE7"){
				    			$(".restaurant_box .aside_box_wrap").append(content);
				    	...
				    	for(var i=0;i<len;i++){
				    		...
				    		var content =
					        		...
					        		+  
			              			result[i].place_name+
			                	"</div>";
				    		if(result[i].category_group_code==="AT4"){
				    			if(i===0){
				    				$(".tour_box .aside_box_wrap").html("");
				    			}
				    			
				    			$(".tour_box .aside_box_wrap").append(content);
				    		}else if(result[i].category_group_code==="AD5"){
				    			$(".tour_box .aside_box_wrap").append(content);
				    	...
				    	for(var i=0;i<len;i++){
				    		...
				    		var content =
					        		...
					        		+  
			              			result[i].place_name+
			                	"</div>";
				    		if(result[i].category_group_code==="HP8"){
				    			if(i===0){
				    				$(".medical_box .aside_box_wrap").html("");
				    			}
				    			
				    			$(".medical_box .aside_box_wrap").append(content);
				    		}else if(result[i].category_group_code==="PM9"){
				    			$(".medical_box .aside_box_wrap").append(content);
				    	...
				    	for(var i=0;i<len;i++){
				    		...
				    		var content =
					        		...
					        		+  
			              			result[i].place_name+
			                	"</div>";
				    		if(result[i].category_group_code==="CT1"){
				    			if(i===0){
				    				$(".convenient_box .aside_box_wrap").html("");
				    			}
				    			
				    			$(".convenient_box .aside_box_wrap").append(content);
				    		}else if(result[i].category_group_code==="CS2"){
				    			$(".convenient_box .aside_box_wrap").append(content);
		    	...
		    	$(".restaurant_box .aside_box_wrap").html(chrg.restaurantCont);
		    	$(".tour_box .aside_box_wrap").html(chrg.tourCont);
		    	$(".medical_box .aside_box_wrap").html(chrg.medicalCont);
		    	$(".convenient_box .aside_box_wrap").html(chrg.convenientCont);
		    	$(".mart_box .aside_box_wrap").html(chrg.martCont);
